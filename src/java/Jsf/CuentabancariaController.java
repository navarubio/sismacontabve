...
public class CuentabancariaController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundlebanco").getString("CuentabancariaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundlebanco").getString("CuentabancariaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundlebanco").getString("CuentabancariaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Cuentabancaria getCuentabancaria(java.lang.Integer id) {
    ...
    public static class CuentabancariaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getCuentabancaria(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cuentabancaria) {
                ...
                return getStringKey(o.getIdcuentabancaria());
            } else {
