...
public class reporteArticulo {
    ...
    public void getReporteProvee(String ruta, int empre) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        if (ruta != null) {
    ...
    public void getReporteClient(String ruta, int empre) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        if (ruta != null) {
