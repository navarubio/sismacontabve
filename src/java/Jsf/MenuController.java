...
public class MenuController implements Serializable {
    ...
    @EJB
    private Jpa.MenuFacadeLocal ejbFacade;
    ...
    public void create() {
        ...
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundlemenu").getString("MenuCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundlemenu").getString("MenuUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundlemenu").getString("MenuDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Menu> getItems() {
        if (items == null) {
            items = getFacade().detallesOrdenados();
        }
        return items;
    }
