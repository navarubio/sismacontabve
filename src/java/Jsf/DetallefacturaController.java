...
public class DetallefacturaController implements Serializable {
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundlefactura").getString("DetallefacturaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundlefactura").getString("DetallefacturaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class DetallefacturaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Detallefactura) {
                ...
                return getStringKey(o.getIddetallefact());
            } else {
