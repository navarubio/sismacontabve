...
public class EstatuscontableController implements Serializable {
    ...
    @EJB
    private Jpa.EstatuscontableFacadeLocal ejbFacade;
    ...
    private EstatuscontableFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("EstatuscontableCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("EstatuscontableUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("EstatuscontableDeleted"));
        if (!JsfUtil.isValidationFailed()) {
