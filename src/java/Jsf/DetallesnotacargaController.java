...
@Named("detallesnotacargaController")
@ViewScoped
public class DetallesnotacargaController implements Serializable {
    ...
    public DetallesnotacargaController() {
    }
    ...
    public static class DetallenotacargaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            DetallesnotacargaController controller = (DetallesnotacargaController) facesContext.getApplication().getELResolver().
